...
<div class="dictionary-show">
    ...
    <p>
        <?= Html::button('Добавить новое предложение', ['class' => 'btn btn-primary', 'data-bs-toggle' => 'collapse', 'data-bs-target' => '#collapseExample','aria-expanded' => 'false', 'aria-controls' => 'collapseExample']) ?>
